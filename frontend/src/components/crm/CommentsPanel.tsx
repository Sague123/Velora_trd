...
export function CommentsPanel({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      <div
        className="anim-rise flex max-h-[85vh] w-full max-w-lg flex-col overflow-hidden rounded-xl border border-line bg-bg-1 shadow-panel"
        ...
        {totalPages > 1 && (
          <div className="flex shrink-0 items-center justify-between border-t border-line-soft px-3 py-2 text-2xs text-txt-2">
            <button
              ...
              className="btn-fx rounded border border-line px-2.5 py-1 disabled:opacity-40"
            >
              Назад
            </button>
