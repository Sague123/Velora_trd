...
import { LANDING_WRAP, Node, SectionLabel, Stroke, TechLabel } from "./primitives";
...
export function SupportSection() {
  ...
  return (
    <section aria-labelledby="support-title" className="border-y border-line bg-bg-1 py-20 lg:py-28">
