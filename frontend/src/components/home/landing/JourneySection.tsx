...
import { DirectionMarker, LANDING_PANEL, LANDING_PANEL_GUTTER, LANDING_WRAP, Node, SectionLabel, Stroke, TechLabel } from "./primitives";
...
export function JourneySection() {
  ...
  return (
    <section aria-labelledby="journey-title" className={LANDING_PANEL_GUTTER}>
