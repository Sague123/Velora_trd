...
export const IconPhone = (p: IconProps) => base({ ...p, children: <path d="M7.5 3.5h-2A2.5 2.5 0 0 0 3 6.2C3 14 10 21 17.8 21a2.5 2.5 0 0 0 2.7-2.5v-2a1 1 0 0 0-.8-1l-3.4-.7a1 1 0 0 0-1 .4l-1 1.4a13.5 13.5 0 0 1-5.9-5.9l1.4-1a1 1 0 0 0 .4-1l-.7-3.4a1 1 0 0 0-1-.8Z" /> });
export const IconMail = (p: IconProps) => base({ ...p, children: <><rect x="3" y="5" width="18" height="14" rx="2" /><path d="m3.5 7 8.5 6 8.5-6" /></> });
export const IconCalendar = (p: IconProps) => base({ ...p, children: <><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M3 10h18M8 3v4M16 3v4" /></> });
export const IconColumns = (p: IconProps) => base({ ...p, children: <><rect x="3" y="4" width="18" height="16" rx="2" /><path d="M9.5 4v16M15 4v16" /></> });
